...
# a config file.
# 
# - escape_latex - strip_dollars - markdown2html - markdown2rst - get_lines -
# ansi2latex - comment_lines - wrap_text - ipython2python - strip_ansi -
# add_anchor - markdown2latex - ansi2html - html2text - strip_files_prefix -
# highlight2latex - citation2latex - indent - posix_path - highlight2html -
# filter_data_type - path2url - add_prompts - ascii_only
...
# 
# c.ExtractOutputPreprocessor.extract_output_types = {'svg', 'jpeg', 'application/pdf', 'png'}
